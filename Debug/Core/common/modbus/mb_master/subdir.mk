...
C_SRCS += \
../Core/common/modbus/mb_master/sm_mb_master_impl.c 

OBJS += \
./Core/common/modbus/mb_master/sm_mb_master_impl.o 

C_DEPS += \
./Core/common/modbus/mb_master/sm_mb_master_impl.d 


# Each subdirectory must supply rules for building sources it contributes
Core/common/modbus/mb_master/%.o Core/common/modbus/mb_master/%.su Core/common/modbus/mb_master/%.cyclo: ../Core/common/modbus/mb_master/%.c Core/common/modbus/mb_master/subdir.mk
...
clean: clean-Core-2f-common-2f-modbus-2f-mb_master

clean-Core-2f-common-2f-modbus-2f-mb_master:
	-$(RM) ./Core/common/modbus/mb_master/sm_mb_master_impl.cyclo ./Core/common/modbus/mb_master/sm_mb_master_impl.d ./Core/common/modbus/mb_master/sm_mb_master_impl.o ./Core/common/modbus/mb_master/sm_mb_master_impl.su

.PHONY: clean-Core-2f-common-2f-modbus-2f-mb_master
